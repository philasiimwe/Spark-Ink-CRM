        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md relative">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-black text-white mb-2">Nexus CRM</h1>
                    <p className="text-blue-200 font-medium">Welcome back! Please sign in to continue.</p>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
                    ...
                    <div className="space-y-3 mb-6">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-200 rounded-2xl font-bold text-slate-700 hover:border-blue-400 hover:bg-blue-50 transition-all group"
                        >
                ...
                <div className="mt-8 text-center text-sm text-blue-200">
                    <p>© 2026 Nexus CRM. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
