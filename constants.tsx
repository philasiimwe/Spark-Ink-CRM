...
export const STAGES = [
  { id: 'LEAD', label: 'Lead In', color: 'bg-blue-100 border-blue-200' },
  { id: 'CONTACTED', label: 'Contacted', color: 'bg-indigo-100 border-indigo-200' },
  { id: 'PROPOSAL', label: 'Proposal Sent', color: 'bg-purple-100 border-purple-200' },
  { id: 'NEGOTIATION', label: 'Negotiation', color: 'bg-amber-100 border-amber-200' },
  { id: 'CLOSED_WON', label: 'Won', color: 'bg-emerald-100 border-emerald-200' },
  { id: 'CLOSED_LOST', label: 'Lost', color: 'bg-rose-100 border-rose-200' },
];

export const SOURCES = [
  { id: 'WEBSITE', label: 'Website Inquiry' },
  { id: 'REFERRAL', label: 'Client Referral' },
  { id: 'COLD_OUTREACH', label: 'Cold Outreach' },
  { id: 'PARTNER', label: 'Channel Partner' },
  { id: 'MARKETING', label: 'Paid Marketing' },
  { id: 'OTHER', label: 'Other' },
];

export const PRIORITIES = [
  { id: 'HOT', label: 'Hot', color: 'text-orange-600 bg-orange-50' },
  { id: 'WARM', label: 'Warm', color: 'text-blue-600 bg-blue-50' },
  { id: 'COLD', label: 'Cold', color: 'text-slate-600 bg-slate-50' },
];
